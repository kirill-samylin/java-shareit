...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(long userId, CreateItemDto dto) {
    ...
    public ResponseEntity<Object> addComment(long userId, long itemId, CreateCommentDto body) {
